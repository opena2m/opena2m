...
|----|-------|------|----------|--------|------------|--------|
| INFRA-001 | Repo, CI, Docker Compose & Seed | W1–W2 | P1 | pending | — | GW-001, ADP-001, UI-001 |
| GW-001 | Gateway Core (state machine, DB, auth, AIMP verbs) | W2–W9 | P1 | pending | INFRA-001 | GW-002, GW-003, UI-001, MCP-001 |
| ADP-001 | Adapter SDK + Print2D Sim | W2–W5 | P1 | pending | INFRA-001 | GW-002 |
| GW-002 | Gateway HITL, SSE, Webhooks + FDM Sim | W9–W14 | P1 | pending | GW-001, ADP-001 | GW-003, UI-001 |
| UI-001 | Console Core (Dashboard, Jobs, Review Queue) | W6–W14 | P1 | pending | GW-001 | UI-002 |
| GW-003 | Policy Engine, Budget Engine, Audit Log | W14–W20 | P1 | pending | GW-002 | UI-002, MCP-001 |
| UI-002 | Console Advanced (Policy, Budget, Audit, Settings) | W18–W22 | P1 | pending | GW-003, UI-001 | MCP-001 |
| MCP-001 | MCP Bridge | W21–W24 | P1 | pending | GW-003 | — |
