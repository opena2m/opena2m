...
from app.routers import discover, quote, execute, telemetry, abort, resume, jobs, devices, domains, policies, budgets, webhooks, audit as audit_router, metrics as metrics_router
